...
- ⏳ P18 : Tunnel WhatsApp dynamique — buildWhatsappLink() shared util + useMemo sur selectedColor/selectedSize/quantity + image produit injectée — en attente d'audit (branche feature/whatsapp-tunnel-dynamic)
