...
| VG19 | i18n pages réglementaires | Dictionnaire de traduction isolé (`legal-translation-dictionary.json`) : 118 clés × 3 locales (FR complet, EN 57 traduites / 61 pending, AR 57 traduites / 61 pending) ; préfixes `mentions.`, `privacy.`, `cgv.`, `legal.` ; prêt pour intégration dans `dictionaries.ts` | ✅ STRUCTURE DICTIONNAIRE VALIDÉE (Prête pour traductions EN/AR) |
