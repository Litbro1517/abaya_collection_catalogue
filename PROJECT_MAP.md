...
- ⏳ P22 : Orders V4.1 Refonte — i18n adminOrder.* + OrderHistory + search ILIKE + inline edit + archive/purge + DataQualityIcon — en attente d'audit (branche feature/orders-refactor)
