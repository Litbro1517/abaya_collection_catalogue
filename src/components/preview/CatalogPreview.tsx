              ...
              {(s?.whatsappNumber || s?.messengerLink || s?.instagramHandle || s?.facebookPage || s?.tiktokHandle) && (
                <div className="flex flex-col items-start text-start gap-3">
                  ...
                  <div className="flex items-center gap-2.5">
                    {/* Instagram — unified: gold-bordered circle, black stroke icon */}
                    {s?.instagramHandle && (
                      <a
                    ...
                    {/* Facebook — unified: black stroke icon in gold-bordered circle (no blue background) */}
                    {s?.facebookPage && (
                      <a
                    ...
                    {/* TikTok — unified: gold-bordered circle, black stroke icon */}
                    {s?.tiktokHandle && (
                      <a
                    ...
                    {/* WhatsApp — unified: gold-bordered circle, black stroke icon */}
                    {s?.whatsappNumber && (
                      <a
